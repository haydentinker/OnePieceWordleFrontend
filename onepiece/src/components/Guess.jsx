...
export const Guess = ({guesses}) => {
  ...
  const character2={Name:"Aggie",Debut:"Episode 20",Affiliations:"Straw Hat Pirates,Straw Hat Grand Fleet,Vinsmoke Family (former), Baratie (resigned), Germa Kingdom (defected), Ninja-Pirate-Mink-Samurai Alliance (disbanded)",
